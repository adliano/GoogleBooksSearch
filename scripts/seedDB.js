...
const bookSeed = [
  {
    ...
    previewLink:
      'http://books.google.com/books?id=hhiVyuHS76UC&printsec=frontcover&dq=turbo&hl=&cd=1&source=gbs_api',
    description: 'Automotive technology.',
    imageLinks: {
      thumbnail:
        'http://books.google.com/books/content?id=hhiVyuHS76UC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api'
    }
  },
  {
    ...
    previewLink:
      'http://books.google.com/books?id=7opUuAEACAAJ&dq=turbo&hl=&cd=2&source=gbs_api'
  },
  {
    ...
    previewLink:
      'http://books.google.com/books?id=646PVGF2Bd8C&printsec=frontcover&dq=turbo&hl=&cd=3&source=gbs_api',
    imageLinks: {
      thumbnail:
        'http://books.google.com/books/content?id=646PVGF2Bd8C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api'
    }
  },
  {
    title: 'Turbo',
    ...
    previewLink:
      'http://books.google.com/books?id=ufhfa3jbow4C&q=turbo&dq=turbo&hl=&cd=4&source=gbs_api',
    description:
      'Explains how to maintain, remove, tear down, assemble, repair, modify, and install Turbo Hydra-matic transmissions',
    imageLinks: {
      thumbnail:
        'http://books.google.com/books/content?id=ufhfa3jbow4C&printsec=frontcover&img=1&zoom=1&source=gbs_api'
    }
  },
  {
